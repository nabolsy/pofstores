...
<div id="right-panel" class="right-panel">
    ...
    <section id="storeOwnerPage">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">StoreOwners Inventory Page</h2>
                    <p>Checkout All StoreOwners</p>
                    <hr class="my-4">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    <form class="form">
                        <a href="<c:url value="/signup-storeowner"/>" class="btn btn-success form-control" ">
                        Add StoreOwner
                        </a>
                    </form>
                </tr>
                <tr>
                    <th>StoreOwner Name</th>
                    <th>Email</th>
                    <th>Password</th>
                    <th></th>
                </tr>
                ...
                <tbody>
                <c:forEach items="${storeOwners}" var="storeOwner">
                    <tr>
                        <td>${storeOwner.storeOwnerName}</td>
                        <td>${storeOwner.storeOwnerEmail}</td>
                        <td>${storeOwner.storeOwnerPassword}</td>
                        <td>
                            <a href="<c:url value="/admin/storeOwners"/>">
