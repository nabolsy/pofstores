...
<div id="right-panel" class="right-panel">
    ...
    <section id="brandinventory">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Brand Inventory Page</h2>
                    <p>Checkout All Awesome Brands</p>
                    <hr class="my-4">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    <form class="form">
                        <a href="<c:url value="/admin/brandInventory/addBrand"/>" class="btn btn-success form-control" ">
                        Add Brand
                        </a>
                    </form>
                </tr>
                ...
                <c:forEach items="${brands}" var="brand">
                    <tr>
                        ...
                        <td>${brand.brandCondition}</td>
                        <td>${brand.brandStatus}</td>
                        <td>
                            <a href="<c:url value="/admin/brandInventory"/>">
