        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<c:url value="/admin"/>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<c:url value="/admin/productInventory"/>">Products</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="<c:url value="/admin/brandInventory"/>">Brands</a></li>
                            <li><i class="fa fa-id-card-o"></i><a href="<c:url value="/admin/productInventory"/>">Carts</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="<c:url value="/admin/users"/>">Users</a></li>
                            <li><i class="fa fa-table"></i><a href="<c:url value="/admin/storeOwners"/>">Store Owners</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Stores</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Sports</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Advanced elec.</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
