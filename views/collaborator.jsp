...
<%@include file="/WEB-INF/views/template/storeowner_left_panel.jsp"%>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="alert  alert-success alert-dismissible fade show" role="alert">
                        <span class="badge badge-pill badge-success">Success</span> Thanks for adding Stores.
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Collaborator Page</h2>
                    <p>the Sub master of the Store!</p>
                    <hr class="my-4"><br>
                    <h2>Here you can view , check and modify the products!</h2>
                </div>
            </div>
        </div>
    </section>
