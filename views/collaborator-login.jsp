    ...
    <div class="container">
        <div class="login-content">
            <div class="login-form">
                ...
                <form:form action="${pageContext.request.contextPath}/collaborator-login" method="post" commandName="collaborator">

                    <div class="form-group">
                        <label for="collaboratorName">Name</label> <span style="color: red;">${notFoundMsg}</span><form:errors path="collaboratorName" cssStyle="color: red;" />
                        <form:input path="collaboratorName" id="collaboratorName" cssClass="form-control" />
                    </div>


                    <div class="form-group">
                        <label for="collaboratorPassword">Password</label>
                    ...
                    <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" href="<c:url value="/collaborator"/>">Log In</button>

                </form:form>
                <div class="register-link m-t-15 text-center">
                    <p>Or Register from here ? <a href="<c:url value="/signup-collaborator"/>"> Register</a></p>
                </div>
            </div>
        </div>
    </div>
